-- Adicionar trigger de UPDATE para atualizar cotas quando participação é editada
DROP TRIGGER IF EXISTS update_quotas_on_participacao_change ON participacoes;

-- Recriar a função do trigger para lidar com UPDATE também
...
BEGIN
    ...
    ELSIF TG_OP = 'UPDATE' THEN
        -- Remover quantidade antiga e adicionar nova
        UPDATE public.concursos 
...
-- Recalcular todas as cotas vendidas para garantir consistência
UPDATE concursos 
